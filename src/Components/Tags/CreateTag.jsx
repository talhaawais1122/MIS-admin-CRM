...
const CreateTag = () => {
  ...
  const token =  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFkbWluQG1lbGRpbi5jbyIsImlhdCI6MTczMzg0MTgxOCwiZXhwIjoxNzMzODQ5MDE4fQ.v0R-fdf3aMhJjWZDWuifUDfbqjheNFbgGQjUu6FZWoU"
